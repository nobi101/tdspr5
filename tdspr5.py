...
def idelay(delaymin,delaymax):
	...
	for demtg in range(int(delay),-1,-1):
		print(trang+'['+xanh+'FRIVE-TOOL'+trang+'] ['+xanh+'L         '+trang+'] ['+xanh+str(demtg)+trang+']',end='     \r')
		sleep(0.1)
		print(trang+'['+cam+'FRIVE-TOOL'+trang+'] ['+cam+'L'+xanh+'O        '+trang+'] ['+cam+str(demtg)+trang+']',end='     \r')
		sleep(0.1)
		print(trang+'['+blue+'FRIVE-TOOL'+trang+'] ['+blue+'L'+xanh+'O'+cam+'A       '+trang+'] ['+blue+str(demtg)+trang+']',end='     \r')
		sleep(0.1)
		print(trang+'['+lam+'FRIVE-TOOL'+trang+'] ['+lam+'L'+xanh+'O'+cam+'A'+blue+'D      '+trang+'] ['+lam+str(demtg)+trang+']',end='    \r')
		sleep(0.1)
		print(trang+'['+tim+'FRIVE-TOOL'+trang+'] ['+tim+'L'+xanh+'O'+cam+'A'+blue+'D'+lam+'I     '+trang+'] ['+tim+str(demtg)+trang+']',end='    \r')
		sleep(0.1)
		print(trang+'['+xnhac+'FRIVE-TOOL'+trang+'] ['+xnhac+'L'+xanh+'O'+cam+'A'+blue+'D'+lam+'I'+tim+'N    '+trang+'] ['+xnhac+str(demtg)+trang+']',end='    \r')
		sleep(0.1)
		print(trang+'['+den+'FRIVE-TOOL'+trang+'] ['+den+'L'+xanh+'O'+cam+'A'+blue+'D'+lam+'I'+tim+'N'+xnhac+'G   '+trang+'] ['+den+str(demtg)+trang+']',end='    \r')
		sleep(0.1)
		print(trang+'['+do+'FRIVE-TOOL'+trang+'] ['+do+'L'+xanh+'O'+cam+'A'+blue+'D'+lam+'I'+tim+'N'+xnhac+'G.  '+trang+'] ['+do+str(demtg)+trang+']',end='     \r')
		sleep(0.2)
		print(trang+'['+vang+'FRIVE-TOOL'+trang+'] ['+vang+'L'+xanh+'O'+cam+'A'+blue+'D'+lam+'I'+tim+'N'+xnhac+'G.. '+trang+'] ['+vang+str(demtg)+trang+']',end='       \r')
		sleep(0.2)
		print(trang+'['+vang+'FRIVE-TOOL'+trang+'] ['+vang+'L'+xanh+'O'+cam+'A'+blue+'D'+lam+'I'+tim+'N'+xnhac+'G...'+trang+'] ['+vang+str(demtg)+trang+']',end='      \r')
...
def NhapTds():
	while True:
		if os.path.exists('frive-TokenTds.txt'):
			with open('frive-TokenTds.txt','r')as f:
			...
			if chon=='1':
				...
				os.remove('frive-TokenTds.txt'); khang(30)
			else:
				print(do+'LỰA CHỌN KHÔNG XÁC ĐỊNH.'); khang(30); continue
		if not os.path.exists('frive-TokenTds.txt'):
			while True:
				khang(30)
				...
				if 'error' in login:
					...
					user=login['user']
					with open('frive-TokenTds.txt','w')as f:
...
def error(id,type,dem):
	time=datetime.now().strftime('%H:%M:%S')
	uid=id.split('_')[1]if '_' in id else id
	print(f'{do}[{vang}{dem}{do}] <|>{time} <|> {type} <|> {uid} <|> ERROR',end='    \r')
def NhapCookieFb():
	list=[]
	oo=[]
	a=0
...
def LuuCookie():
	while True:
		if os.path.exists('frive-Cookie-Page-Fb-tds.txt'):
			...
			chon=input(edit+'VUI LÒNG NHẬP LỰA CHỌN: '+trang)
			if chon=='1':
				with open('frive-Cookie-Page-Fb-tds.txt','r')as f:
					list=json.loads(f.read())
					break
			elif chon=='2':
				os.remove('frive-Cookie-Page-Fb-tds.txt'); khang(30)
			else:
				print(do+'LỰA CHỌN KHÔNG XÁC ĐỊNh.'); khang(30); continue
		if not os.path.exists('frive-Cookie-Page-Fb-tds.txt'):
			list=NhapCookieFb()
			with open('frive-Cookie-Page-Fb-tds.txt','w')as f:
				json.dump(list,f)
			break
	return list
def main():
	...
	while True:
		...
		for datack in listck['data']:
			...
			try:
				...
				listck.remove(datack)
				try:os.remove('frive-Cookie-Page-Fb-tds.txt')
				except:print(end='\r')
main()
